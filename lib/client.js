window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/hongbo/dsh/dsh-plugin-mobile-shell/src/client/NarrowShell.module.css.mjs
		const css$1 = ".l8vqCa_hamburger{z-index:40;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:34px;height:34px;color:var(--dsw-alias-label-primary);cursor:pointer;pointer-events:auto;border-radius:9px;justify-content:center;align-items:center;display:flex;position:absolute;top:8px;left:8px}.l8vqCa_hamburger:hover{background:var(--dsw-alias-interactive-bg-hover)}.l8vqCa_scrim{z-index:35;background:var(--dsw-alias-bg-mask-1);pointer-events:auto;position:absolute;inset:0}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/hongbo/dsh/dsh-plugin-mobile-shell/src/client/narrow-shell.css.mjs
